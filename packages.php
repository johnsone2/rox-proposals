<?php include 'header_nav.php'; ?>
    ...
    <div class="row-fluid">
        ...
        <div id="pe" class="span11">
            <p class="lead">We pride our boutique style business on building close relationships with every person we work with.
                Although there are many technologically advanced options out there to meet virtually, we still require face to face appointments in order to truly understand each and every client and their individual needs.
            </p>
        </div>

        <div id="cpi" class="span11" style="display: none;">
            <p class="lead">This package is right for someone who wants to execute a plan on their own but needs a jump start with ideas.
                A detailed question and answer session will be held, after which three personalized options will be presented.
                Of course we will always be available for advice or questions as you plan your perfect proposal. </br></br>
                Need more help after the proposal? A la carte items include ring shopping and post engagement party planning, click here to discover how our a la carte options can compliment your conception and event planning packages!
            </p>
        </div>

        <div id="epi" class="span11" style="display: none;" >
            <p class="lead">Looking for a middle ground with your proposal planning? Let us meet you <i>more than</i> halfway!
