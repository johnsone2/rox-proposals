<?php include 'header_nav.php'; ?>
    ...
    <div>
        ...
        <p class="lead">Keeping it in the family, we are Denver-native cousins that have a passion for event planning and love stories.
            As our family has grown over the years, and with each proposal more creative than the last,  we have become increasingly eager to plan proposals and celebrate the milestone that is an engagement. Let us make your family just as excited about love as ours is, they’ll be talking about your proposal for years to come!</p>

    </div>
    <div class="row-fluid thumbnail light-background" style="margin-bottom: 20px;">

        <div class="span3" style="text-align: center;">
            <h3 >Christina</h3>
            <img alt="Christina Forrest" title="Christina Forrest" src="img/stock/forrest.jpg">
        </div>
        <div class="span9">
    ...
    <div class="row-fluid thumbnail light-background">
        <div class="span3" style="text-align: center;">
            <h3>Larisa</h3>
            <img alt="Larisa Barber" title="Larisa Barber" src="img/stock/barber.jpg">
        </div>
        <div class="span9">
            <div class="caption" >
